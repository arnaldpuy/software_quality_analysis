---
title: "Mapping the hidden topology of software risk in scientific models"
author: "Arnald Puy"
header-includes:
...
```{r plot_c_fraction, fig.height=2, fig.width=2.3}
...
```{r risk_score_paths, dependson="data_risky_paths"}
...
```{r plot_risky_paths, dependson="risk_score_paths", fig.height=3, fig.width=3.5}
