...
```{r plot_scatterplot, dependson="read_metrics_function_data", fig.height=1.7, fig.width=2.5}
...
```{r plot_c_model, dependson="read_metrics_function_data", fig.height=2.2, fig.width=3.1}
...
```{r plot_c_fraction, fig.height=2, fig.width=3.5}
...
```{r merge_3, dependson=c("plot_c_model", "plot_c_fraction", "merge_plots_lines_comment_density", "merge_scatter"), fig.height=5.4, fig.width=6}

di <- plot_grid(plot_scatterplot, plot_bar_cyclomatic, ncol = 1, labels = "auto")

bottom <- plot_grid(di, plot_c_model, plot_bar_category, ncol = 3, rel_widths = c(0.32, 0.4, 0.28))
plot_grid(p1, bottom, ncol = 1, rel_heights = c(0.6, 0.4))
```

```{r merge_4, dependson=c("plot_c_model", "plot_c_fraction", "merge_plots_lines_comment_density", "merge_scatter"), fig.height=5.6, fig.width=6}
...
plot_grid(p1, dada3, ncol = 1, rel_heights = c(0.6, 0.4))
```

```{r merge_5, dependson=c("plot_c_model", "plot_c_fraction", "merge_plots_lines_comment_density", "merge_scatter"), fig.height=7.2, fig.width=6}
